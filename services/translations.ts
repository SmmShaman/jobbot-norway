...
export const translations = {
  en: {
    ...
    jobs: {
      ...
      dateFilter: 'Date',
      showingRecent: 'Last 2 months',
      loadAllJobs: 'Load all',
      showingAll: 'All time',
      extract: 'Extract',
      analyze: 'Analyze',
      rescan: 'Rescan',
  ...
  no: {
    ...
    jobs: {
      ...
      dateFilter: 'Dato',
      showingRecent: 'Siste 2 måneder',
      loadAllJobs: 'Last alle',
      showingAll: 'Alle',
      extract: 'Hent info',
      analyze: 'Analyser',
  ...
  uk: {
    ...
    jobs: {
      ...
      dateFilter: 'Дата',
      showingRecent: 'Останні 2 місяці',
      loadAllJobs: 'Завантажити всі',
      showingAll: 'За весь час',
      extract: 'Витягнути',
      analyze: 'Аналізувати',
